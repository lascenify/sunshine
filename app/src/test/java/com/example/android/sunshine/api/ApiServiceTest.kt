...
class ApiServiceTest {
    ...
    fun getForecastByCity(){
        ...
        val forecast = apiService.forecastByCity(cityName).getOrAwaitValue().data
    ...
    fun getForecastByCoordinates(){
        ...
        val forecast = apiService.forecastByCoordinates(lat = lat, long = lon, units = units).getOrAwaitValue().data
        assertThat(forecast, notNullValue())
    ...
    fun getForecastByCityId(){
        ...
        val forecast = apiService.forecastByCityId(cityId = cityId).getOrAwaitValue().data
        assertThat(forecast, notNullValue())
        assertThat(forecast?.city?.name, `is`("Cieza"))
        assertThat(forecast?.list?.size, `is`(40))
    }
