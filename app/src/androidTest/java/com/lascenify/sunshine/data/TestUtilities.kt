...
import com.lascenify.sunshine.data.DatabaseTest.Companion.REFLECTED_COLUMN_DATE
import com.lascenify.sunshine.data.DatabaseTest.Companion.REFLECTED_COLUMN_HUMIDITY
import com.lascenify.sunshine.data.DatabaseTest.Companion.REFLECTED_COLUMN_MAX
import com.lascenify.sunshine.data.DatabaseTest.Companion.REFLECTED_COLUMN_MIN
import com.lascenify.sunshine.data.DatabaseTest.Companion.REFLECTED_COLUMN_PRESSURE
import com.lascenify.sunshine.data.DatabaseTest.Companion.REFLECTED_COLUMN_WEATHER_ID
import com.lascenify.sunshine.data.DatabaseTest.Companion.REFLECTED_COLUMN_WIND_DIR
import com.lascenify.sunshine.data.DatabaseTest.Companion.REFLECTED_COLUMN_WIND_SPEED
import com.lascenify.sunshine.util.PollingCheck
import com.lascenify.sunshine.utilities.SunshineDateUtils
...
internal object TestUtilities {
    ...
    fun createTestWeatherContentValues(): ContentValues {
        ...
        testWeatherValues.put(REFLECTED_COLUMN_DATE,
            DATE_NORMALIZED
        )
    ...
    fun createBulkInsertTestWeatherValues(): Array<ContentValues?> {
        ...
        for (i in 0 until BULK_INSERT_RECORDS_TO_INSERT) {
            ...
            weatherValues.put(REFLECTED_COLUMN_HUMIDITY, 1.2 + 0.01 * i.toFloat())
            weatherValues.put(REFLECTED_COLUMN_PRESSURE, 1.3 - 0.01 * i.toFloat())
            weatherValues.put(REFLECTED_COLUMN_MAX, 75 + i)
            weatherValues.put(REFLECTED_COLUMN_MIN, 65 - i)
            weatherValues.put(REFLECTED_COLUMN_WIND_SPEED, 5.5 + 0.2 * i.toFloat())
