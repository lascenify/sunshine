 ...
 * like, you may implement them on your own.
 */
public class WeatherProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        appDatabase = AppDatabase.Companion.getInstance(getContext());
        forecastDao = appDatabase.weatherForecastDao();
        return true;
    }
            ...
            case CODE_WEATHER:
                ...
                try {
                    for (ContentValues value : values) {
                        ...
                        long _id = appDatabase.weatherForecastDao().insertForecast(value);
...
/*
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case CODE_WEATHER_WITH_DATE: {
                ...
                cursor = appDatabase.getReadableDatabase().query(
...
return null;
    ...
    public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (sUriMatcher.match(uri)) {
            case CODE_WEATHER:
                numRowsDeleted = appDatabase.getWritableDatabase().delete(
                        WeatherContract.WeatherEntry.TABLE_NAME,
                        selection,
                        selectionArgs);
                break;
